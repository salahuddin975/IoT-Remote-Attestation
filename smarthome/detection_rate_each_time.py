...
if __name__ == "__main__":
    ...
    fields = ['num_of_blocks', 'block_size', 'covered_memory_size', 'detection_rate', 'avg_spend_time', 'spend_times']
    filename = "detection_rate_each_time.csv"
    ...
    with open(filename, 'w') as csvfile: 
        ...
        for n in range(num_of_iteration):
            ...
            for i in range(num_of_seeds):
                ...
                msg = str(checksum_type) + " " + str(seed) + " " + str(num_of_blocks) + " " + str(block_size) + " "
                msg = bytes(msg, 'ascii')
            ...
            avg_spend_time = total_time/num_of_seeds
            covered_memory = (num_of_blocks * block_size * 100)/total_memory_size
            detection_rate = (num_of_detection * 100)/num_of_seeds

            csvwriter.writerow([num_of_blocks, block_size, covered_memory, detection_rate, avg_spend_time, times])
            print ("num_of_block: ", num_of_blocks, "; block_size: ", block_size, "; covered_memory: ", covered_memory, "%; detection_rate: ", detection_rate, "; avg_spend_time: ", avg_spend_time)
            time.sleep(1)        
